...
/************************************************/	
	...
	//Construct gallery panels from '.panel' <div>s
		function buildPanels() {
			...
			if(!opts.show_filmstrip) {
				...
				$('<img />').addClass('nav-next').attr('src',opts.nav_theme+'/next.gif').appendTo(j_gallery).css({
					'position':'absolute',
					'zIndex':'1100',
					'cursor':'pointer',
				...
				$('<img />').addClass('nav-prev').attr('src',opts.nav_theme+'/prev.gif').appendTo(j_gallery).css({
					'position':'absolute',
					'zIndex':'1100',
					'cursor':'pointer',
					'top':((opts.panel_height-22)/2)+gallery_padding+'px',
				...
				$('<img />').addClass('nav-next-overlay').attr('src',opts.nav_theme+'/panel-nav-next.gif').appendTo(j_gallery).css({
					'position':'absolute',
					'zIndex':'1099',
				...
				$('<img />').addClass('nav-prev-overlay').attr('src',opts.nav_theme+'/panel-nav-prev.gif').appendTo(j_gallery).css({
					'position':'absolute',
					'zIndex':'1099',
					'top':((opts.panel_height-22)/2)+gallery_padding-10+'px',
					'left':'0',
	...
	//Construct filmstrip from '.filmstrip' <ul>
		function buildFilmstrip() {
			...
			//Add navigation buttons
			var navNext = $('<img />');
			navNext.addClass('nav-next').attr('src',opts.nav_theme+'/next.gif').appendTo(j_gallery).css({
				'position':'absolute',
				'cursor':'pointer'
			}).click(showNextItem);
			var navPrev = $('<img />');
			navPrev.addClass('nav-prev').attr('src',opts.nav_theme+'/prev.gif').appendTo(j_gallery).css({
				'position':'absolute',
				'cursor':'pointer'
			}).click(showPrevItem);
			if(filmstrip_orientation=='horizontal') {
