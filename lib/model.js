...
exports.Room.enter_queue = room_enter_queue = function (err, room, req, cb) {
  ...
  Player.collection.findAndModify( {
      ...
      function (err, player) {
        ...
        Room.get(err, player.room_id, function (err, my_room) {
          ...
          my_room.player_queue.push(req.session.player_id);
...
exports.Room.leave_queue = room_leave_queue = function (err, room, req, cb) {
  ...
  Player.collection.findAndModify( {
      ...
      function (err, player) {
        ...
        Room.get(err, player.room_id, function (err, my_room) {
          ...
          my_room.player_queue.splice(room.player_queue.indexOf(req.session.player_id), 1);
