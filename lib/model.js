...
exports.Battle.create = battle_create = function (err, obj, cb) {
  ...
  var create_rounds = (typeof  obj.create_rounds !== 'undefined') ? obj.create_rounds : true;
  delete obj['create_rounds'];
  
  var number_of_rounds = (typeof obj.number_of_rounds !== 'undefined') ? obj.number_of_rounds : 3;
      ...
      Room.collection.findAndModify( {
        ...
        if (create_rounds) {
          for (var i=0; i < number_of_rounds; i++) {
		        ...
		        //round_create(null, obj, function (err, round) {
...
exports.Round.collection = battle_collection = mongo_client.collection('roundss');
