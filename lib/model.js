...
exports.Battle.list = battle_list = function (err, query, cb) {
  ...
  get_sorted_array_from_hash(err, Battles, function (err, battles) {
    cb(err, battles);
  });
}
...
exports.Player.list = player_list = function (err, query, cb) {
  ...
  // this is where implementation of the query would occur
  get_sorted_array_from_hash(err, Players, function (err, players) {
    cb(err, players);
  });
...
exports.Room.list = player_list = function (err, query, cb) {
  ...
  // this is where implementation of the query would occur 
  get_sorted_array_from_hash(err, Rooms, function (err, rooms) {
    cb(err, rooms);
  }); 
