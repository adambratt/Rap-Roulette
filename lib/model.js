...
exports.Battle.create = battle_create = function (err, obj, cb) {
  ...
  async.waterfall([
    ...
    function (nextcb) {
      console.log(' select the winning player');  
      ...
      if (obj.previous_battle_id) {
        Battle.collection.findOne({ id: obj.previous_battle_id }, function(err, fetched_prev_battle) { 
          ...
          if (typeof prev_battle.winning_player_id !== 'undefined') {
              console.log(' previous winner: ' + prev_battle.winning_player_id);
              ...
              if (prev_battle.winning_player_id == null) {
                Room.pop_top_queue(null, id, function (err, player_id) {
                  console.log(' the winning player was null (push from top of queue)');
              ...
              // previous player is valid
                ...
                console.log(' there is a winning player');
          ...
          // wtf, no winning!
            ...
            Room.pop_top_queue(null, id, function (err, player_id) {
              console.log(' there is no winning player (push from top of queue)');
              obj.players.push(player_id);
              nextcb(null, true);
            });
          }
        ...
        Room.pop_top_queue(null, obj.room_id, function (err, player_id) {
          console.log(' there is no previous battle (push from top of queue)');
    ...
    function (isGreatSuccess, nextcb) {
      ...
      Room.pop_top_queue(null, obj.room_id, function (err, player_id) {
        console.log(' challenger (pop from top of queue)');
          
          // player at top of queue is null, just use the loser here
          console.log(' challenging player_id is ' + player_id);
          if (typeof player_id === 'undefined' || player_id == null) {
            if (typeof prev_battle !== 'undefined') {
              console.log(' as there are no players in the queue, will try to get loser to challenge');
          ...
          if (previous_winner_position != null) {
            ...
            if (previous_winner_position == 0) {
              obj.players.push(player_id);
              console.log(' prev winner at 0; push to end');
            ...
            // the previous winner is in position 1: unshift challenger to top
              ...
              console.log(' prev winner at 1; unshift to top');
              
            }
          } else {
            obj.players.push(player_id);
            console.log(' push to end');
    ...
    function (isGreatSuccess, nextcb) {
      console.log(' complete the player setup');  
    ...
    function (isGreatSuccess, nexcb) {
      console.log(' set up battle with ' + util.inspect(obj.players));  
