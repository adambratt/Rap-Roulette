  ...
  async.waterfall([
    ...
    function (nextcb) {
      ...
      if (obj.previous_battle_id) {
        Battle.collection.findOne({ id: obj.previous_battle_id }, function(err, prev_battle) { 
...
// node room battle states
exports.Room.battle_states = room_battle_states = {};
// use the room_id to fetch the current battle state for that room
