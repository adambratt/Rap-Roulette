    ...
    //
        ...
        // this remotely authenticated player is in the system
          ...
          Player.collection.findAndModify( {        
              ...
              update : { "$set": { 
                is_logged_in: 1, 
                service: 'facebook', 
                screen_name: fbUserMeta.name, 
                screen_id: fbUserMeta.id, 
                service_username: fbUserMeta.username
              } }, 
              'new': false
            },
            function (err) {
        ...
        //
          ...
          obj = { 
            ...
            service: 'facebook', screen_name: fbUserMeta.name, screen_id: fbUserMeta.id, service_username: fbUserMeta.username,
