...
ea.facebook.appId('333001253396957')
    ...
    enterQueue = false;
    if (typeof session.enter_queue_after_login !== 'undefined') {
      //console.log('enter queue after: ' + session.enter_queue_after_login);
      enterQueue = session.enter_queue_after_login;
   ...
   .redirectPath('/room/myroom_redirect');
