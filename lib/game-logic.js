  ...
  [function(ss, battle) {
	...
	[function(ss, battle) {
		...
		if (typeof Socket.players[battle.players[0]] !== 'undefined') {
      		Socket.players[battle.players[0]].emit('unmute', 0);
      	}
      	if (typeof Socket.players[battle.players[1]] !== 'undefined') {
      		Socket.players[battle.players[1]].emit('mute', 0);
      	}
    ...
    battle.current_player_id = null;
    	if (typeof Socket.players[battle.players[0]] !== 'undefined') {
      		Socket.players[battle.players[0]].emit('mute', 0);
      	}
      	if (typeof Socket.players[battle.players[1]] !== 'undefined') {
      		Socket.players[battle.players[1]].emit('unmute', 0);
      	}
