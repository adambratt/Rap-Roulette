...
class PHPMailer {
  ...
  function SmtpSend($header, $body) {
    //include_once($this->PluginDir . 'class.smtp.php'); // This is not needed since the smtp class will be automatically included
    $error = '';
    $bad_rcpt = array();
   ...
   * @return bool
   */
  function SetLanguage($lang_type, $lang_path = 'incl/language/') {
